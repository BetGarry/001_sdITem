...
class GeometryEngine {
    ...
    loadContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loadingPromise = new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (version === '1.0') {
                    resolve(yield new GLTFLoader_1.GLTFLoader().load(gltfContent, gltfBinary, gltfHeader, gltfBaseUrl));
                }
                else {
                    resolve(yield new GLTFLoader_2.GLTFLoader().load(gltfContent, gltfBinary, gltfHeader, gltfBaseUrl));
                }
            }));
