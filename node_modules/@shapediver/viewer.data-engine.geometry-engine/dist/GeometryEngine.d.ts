...
export declare class GeometryEngine {
    ...
    private readonly _loadingQueue;
    private readonly _logger;
    private readonly _performanceEvaluator;
    private static _instance;
    private _loadingQueueLength;
    static get instance(): GeometryEngine;
    get parallelGlTFProcessing(): number;
    set parallelGlTFProcessing(value: number);
    /**
