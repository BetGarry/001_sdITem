...
var _AttributeData_morphAttributeData, _AttributeData_array, _AttributeData_byteOffset, _AttributeData_byteStride, _AttributeData_count, _AttributeData_elementBytes, _AttributeData_itemBytes, _AttributeData_itemSize, _AttributeData_max, _AttributeData_min, _AttributeData_normalized, _AttributeData_sparse, _AttributeData_sparseIndices, _AttributeData_sparseValues, _PrimitiveData_attributes, _PrimitiveData_mode, _PrimitiveData_boundingBoxes, _PrimitiveData_indices, _PrimitiveData_material, _PrimitiveData_standardMaterial, _PrimitiveData_effectMaterials, _PrimitiveData_materialVariants, _PrimitiveData_attributeMaterial, _PrimitiveData_threeJsObject, _GeometryData_primitive, _GeometryData_boundingBox, _GeometryData_renderOrder, _GeometryData_morphWeights, _GeometryData_threeJsObject;
...
class PrimitiveData extends viewer_shared_node_tree_1.AbstractTreeNodeData {
     ...
     */
    constructor(attributes = {}, mode = IGeometryData_1.PRIMITIVE_MODE.TRIANGLES, indices = null, material = null, attributeMaterial = null, id, version) {
        super(id, version);
        // #region Properties (5)
    ...
    clone() {
        ...
        return new PrimitiveData(attributes, __classPrivateFieldGet(this, _PrimitiveData_mode, "f"), __classPrivateFieldGet(this, _PrimitiveData_indices, "f"), __classPrivateFieldGet(this, _PrimitiveData_material, "f"), __classPrivateFieldGet(this, _PrimitiveData_attributeMaterial, "f"), this.id, this.version);
    }
...
class GeometryData extends viewer_shared_node_tree_1.AbstractTreeNodeData {
     ...
     */
    clone() {
        return new GeometryData(__classPrivateFieldGet(this, _GeometryData_primitive, "f"), __classPrivateFieldGet(this, _GeometryData_morphWeights, "f"), this.id, this.version);
    }
...
_GeometryData_primitive = new WeakMap(), _GeometryData_boundingBox = new WeakMap(), _GeometryData_renderOrder = new WeakMap(), _GeometryData_morphWeights = new WeakMap(), _GeometryData_threeJsObject = new WeakMap();
