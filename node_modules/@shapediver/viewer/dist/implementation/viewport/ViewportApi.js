...
class ViewportApi {
    ...
    set maximumRenderingSize(value) {
        ...
        try {
            __classPrivateFieldGet(this, _ViewportApi_inputValidator, "f").validateAndError(viewer_shared_services_1.LOGGING_TOPIC.VIEWPORT, `SessionApi.${scope}`, value, 'object');
            __classPrivateFieldGet(this, _ViewportApi_inputValidator, "f").validateAndError(viewer_shared_services_1.LOGGING_TOPIC.VIEWPORT, `SessionApi.${scope}`, value.width, 'number');
            __classPrivateFieldGet(this, _ViewportApi_inputValidator, "f").validateAndError(viewer_shared_services_1.LOGGING_TOPIC.VIEWPORT, `SessionApi.${scope}`, value.height, 'number');
