...
class OutputApi {
    ...
    constructor(output) {
        ...
        __classPrivateFieldGet(this, _OutputApi_output, "f").updateCallback = (newNode, oldNode) => {
    ...
    set updateCallback(value) {
        ...
        __classPrivateFieldGet(this, _OutputApi_logger, "f").debug(`OutputApi.${scope}: ${scope} was updated to ${__classPrivateFieldGet(this, _OutputApi_output, "f").updateCallback}.`);
    }
    get version() {
