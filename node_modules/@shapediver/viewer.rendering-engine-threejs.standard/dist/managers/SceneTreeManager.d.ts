...
export declare class SceneTreeManager implements IManager {
     ...
     */
    updateData(node: ITreeNode, obj: SDObject, data: ITreeNodeData, filter: UpdateFilter, skeleton?: THREE.Skeleton): void;
     ...
     */
    updateNode(node?: ITreeNode, obj?: THREE.Object3D, filter?: UpdateFilter, skeleton?: THREE.Skeleton): void;
