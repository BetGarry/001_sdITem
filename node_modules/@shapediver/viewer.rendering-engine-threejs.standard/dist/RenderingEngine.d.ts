...
import { ISDTFAttributeVisualizationData, ISDTFOverview, ISDTFItemData, IGeometryData, Color } from '@shapediver/viewer.shared.types';
...
export declare class RenderingEngine implements IRenderingEngineThreeJS {
    ...
    applySettings(sections?: {
        ...
        environment?: boolean;
        general?: boolean;
    }, settingsEngine?: SettingsEngine): Promise<void>;
